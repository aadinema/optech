      ...
      <div className={styles.content}>
        <div className={styles.left}>
          ...
          <div className={styles.textSection}>
            <h2>
              Increasing business <br /> success with technology
            </h2>
            <p>
              Each demo built with Teba will look different. You can customize
              almost <br /> anything in the appearance of your website with only
              a few clicks. Each demo built with Teba will look different.
            </p>
          </div>
